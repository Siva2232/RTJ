...
export default function SalesDashboard() {
  ...
  // Unread sale notifications for this user
  ...
  // Filter pending sales and sold cars by the logged-in user if they are sales staff
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-slate-900 text-2xl font-bold">Sales Dashboard</h2>
        ...
        {activeCars.length === 0 ? (
          ...
          <div className="divide-y divide-slate-50">
            {activeCars.map((car) => {
              ...
              return (
                <div key={car._id} className="flex items-center gap-4 px-6 py-4 hover:bg-slate-50 transition-colors">
                  {/* Image */}
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {/* Admin or Sales: full pipeline actions */}
                    {true && (
                      <>
                        {car.status === 'repair' && (
                          <Button
                        ...
                        {car.status === 'sale_pending' && (
                          <div className="flex items-center gap-2 px-3 py-1.5 bg-amber-50 text-amber-700 text-xs font-semibold rounded-lg border border-amber-100 italic">
                    ...
                    {/* Admin: pipeline is read-only — no action buttons */}
                  </div>
                </div>
              );
            })}
        ...
        <div className="bg-white rounded-2xl border border-orange-100 shadow-sm overflow-hidden">
          ...
          <div className="divide-y divide-orange-50">
            {pendingSales.map((car) => (
              <div key={car._id} className="flex items-center gap-4 px-6 py-4 hover:bg-orange-50/30 transition-colors">
      ...
      {/* Sales Record — all sold cars with staff tracking */}
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      <span className="inline-flex items-center gap-1 bg-blue-50 text-blue-700 text-xs font-medium px-2 py-0.5 rounded-full">
                        ...
                        {car.soldBy?.name || 'Unknown'}
                      </span>
                      <span className="text-slate-400 text-xs">{car.soldDate ? new Date(car.soldDate).toLocaleDateString('en-IN') : ''}</span>
                    </div>
                  </div>
